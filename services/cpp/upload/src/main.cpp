...
void RunServer() {
    ...
    const std::string server_cert_path = "/certs/upload-service.crt";
    const std::string server_key_path = "/certs/upload-service.key";

    saasforge::upload::UploadServiceImpl service;
